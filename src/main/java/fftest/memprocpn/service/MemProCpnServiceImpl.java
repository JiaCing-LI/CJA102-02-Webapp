 ...
 * 折價券明細 Service
 */
public class MemProCpnServiceImpl implements MemProCpnbService {
	private MemProCpnDAO_interface dao;

	public MemProCpnServiceImpl() {
		dao = new MemProCpnJDBCDAO(); // 或改成 HibernateDAO / JNDIDAO // 你要有 DAO
										// 的實作類別
	}
	 ...
	 *            折價券有效天數
	 */
	public MemProCpnVO addMemProCpn(Integer memId, Integer proCpnId,
			Integer validDays) {
	...
	public MemProCpnVO updateStatusMemProCpn(Integer cpnHolderDetailId,
			Byte cpnUseStatus) {
